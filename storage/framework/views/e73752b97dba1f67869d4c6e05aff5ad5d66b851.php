    ...
    <section class="flat-row">
        <div class="container">
                ...
                <div class="col-md-12">
                    ...
                    <div class="col-md-3 wrap-teammember">
                        <div class="teammember">
                            <div class="avatar">
                                <img src="<?php echo e(asset('images/jury/badar_khushnood.jpg')); ?>" width="100%">
                    ...
                    <div class="col-md-3 wrap-teammember">
                        <div class="teammember">
                            <div class="avatar">
                                <img src="<?php echo e(asset('images/jury/pavan_dadlani.jpg')); ?>" width="100%">
                                <div class="info-overlay">
                                    <div class="flat-socials">
                                        <a href="#"><i class="fa fa-facebook"></i><i class="fa fa-facebook"></i></a>
                                        <a href="#"><i class="fa fa-twitter"></i><i class="fa fa-twitter"></i></a>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="title-section line">
                        <h1 class="title">Design For Social Impact</h1>
                    </div>
                    <div class="divider"></div>
                    <div class="col-md-3 wrap-teammember">
                        <div class="teammember">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="col-md-3 wrap-teammember">
                        <div class="teammember">
                            <div class="avatar">
                                <img src="<?php echo e(asset('images/jury/sabahat.jpg')); ?>" width="100%">
                                <div class="info-overlay">
                                    <div class="flat-socials">
                                        <a href="#"><i class="fa fa-facebook"></i><i class="fa fa-facebook"></i></a>
                                        <a href="#"><i class="fa fa-twitter"></i><i class="fa fa-twitter"></i></a>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="col-md-3 wrap-teammember">
                        <div class="teammember">
                            <div class="avatar">
                                <img src="<?php echo e(asset('images/jury/shahzad_mughal.jpg')); ?>" width="100%">
                                <div class="info-overlay">
                                    <div class="flat-socials">
                                        <a href="#"><i class="fa fa-facebook"></i><i class="fa fa-facebook"></i></a>
                                        <a href="#"><i class="fa fa-twitter"></i><i class="fa fa-twitter"></i></a>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="col-md-3 wrap-teammember">
                        <div class="teammember">
                            <div class="avatar">
                                <img src="<?php echo e(asset('images/jury/khurram_zafar.jpg')); ?>" width="100%">
                                <div class="info-overlay">
                                    <div class="flat-socials">
                                        <a href="#"><i class="fa fa-facebook"></i><i class="fa fa-facebook"></i></a>
                                        <a href="#"><i class="fa fa-twitter"></i><i class="fa fa-twitter"></i></a>
                    ...
                    <div class="col-md-3 wrap-teammember">
                        <div class="teammember">
                            <div class="avatar">
                                <img src="<?php echo e(asset('images/jury/zia_imran.jpg')); ?>" width="100%">
                                <div class="info-overlay">
                                    <div class="flat-socials">
                                        <a href="#"><i class="fa fa-facebook"></i><i class="fa fa-facebook"></i></a>
                                        <a href="#"><i class="fa fa-twitter"></i><i class="fa fa-twitter"></i></a>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="col-md-3 wrap-teammember">
                        <div class="teammember">
                            <div class="avatar">
                                <img src="<?php echo e(asset('images/jury/ahmed_shuja.jpg')); ?>" width="100%">
                                <div class="info-overlay">
                                    <div class="flat-socials">
                                        <a href="#"><i class="fa fa-facebook"></i><i class="fa fa-facebook"></i></a>
                                        <a href="#"><i class="fa fa-twitter"></i><i class="fa fa-twitter"></i></a>
                            ...
                            <div class="content text-center" style="height: 190px;">
                    ...
                    <div class="col-md-3 wrap-teammember">
                        <div class="teammember">
                            <div class="avatar">
                                <img src="<?php echo e(asset('images/jury/gulraiz_khan.jpg')); ?>" width="100%">
                                <div class="info-overlay">
                                    <div class="flat-socials">
                                        <a href="#"><i class="fa fa-facebook"></i><i class="fa fa-facebook"></i></a>
                                        <a href="#"><i class="fa fa-twitter"></i><i class="fa fa-twitter"></i></a>
                    ...
                    <div class="col-md-3 wrap-teammember">
                        <div class="teammember">
                            <div class="avatar">
                                <img src="<?php echo e(asset('images/jury/diego_dalia.jpg')); ?>" width="100%">
                                <div class="info-overlay">
                                    <div class="flat-socials">
                                        <a href="#"><i class="fa fa-facebook"></i><i class="fa fa-facebook"></i></a>
                                        <a href="#"><i class="fa fa-twitter"></i><i class="fa fa-twitter"></i></a>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="col-md-3 wrap-teammember">
                        <div class="teammember">
                            <div class="avatar">
                                <img src="<?php echo e(asset('images/jury/farwah_tapal.jpg')); ?>" width="100%">
                                <div class="info-overlay">
                                    <div class="flat-socials">
                                        <a href="#"><i class="fa fa-facebook"></i><i class="fa fa-facebook"></i></a>
                                        <a href="#"><i class="fa fa-twitter"></i><i class="fa fa-twitter"></i></a>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="col-md-3 wrap-teammember">
                        <div class="teammember">
                            <div class="avatar">
                                <img src="<?php echo e(asset('images/jury/ali_murtaza.jpeg')); ?>" width="100%">
                                <div class="info-overlay">
                                    <div class="flat-socials">
                                        <a href="#"><i class="fa fa-facebook"></i><i class="fa fa-facebook"></i></a>
                                        <a href="#"><i class="fa fa-twitter"></i><i class="fa fa-twitter"></i></a>
                            ...
                            <div class="content text-center">
                                ...
                                <p class="position">
                                    Program Manager, Makistan (ITU) | Design Consultant
                                </p>
                            </div>
                        </div>
                    </div>
