            ...
            <div class="row">
                <form id="entry_form" class="col-md-6">
                    ...
                    <div class="form-group <?php echo e($errors->has('team') ? ' has-error' : ''); ?>">
                        ...
                        <textarea id="team" name="team" maxlength="800" style="resize: none; height: 150px;" ><?php echo e(old('team')); ?></textarea>
                        <?php if($errors->has('team')): ?>
                            <span class="help-block">
                                        <strong><?php echo e($errors->first('team')); ?></strong>
                                </span>
                        <?php endif; ?>
                    </div>
                    ...
                    <div class="form-group <?php echo e($errors->has('url') ? ' has-error' : ''); ?>">
                        ...
                        <input id="url" type="url" value="<?php echo e(old('url')); ?>" name="url" required>
                    ...
                    <div class="form-group <?php echo e($errors->has('video_url') ? ' has-error' : ''); ?>">
                        ...
                        <input id="video_url" type="url" value="<?php echo e(old('video_url')); ?>" name="video_url" required>
