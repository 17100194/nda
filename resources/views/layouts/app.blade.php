...
<head>
    <link href="http://nationaldesignaward.org" rel="canonical">
    <meta charset="utf-8">
                    ...
                    <div class="wrap-menu-extra <?php if (request()->is('/')):?>color-white<?php endif;?>">
                        <div class="menu-extra text-right <?php if (request()->is('/')):?>color-white<?php endif;?>">
                            <ul>
                                <li>
                                    @if(Auth::guest())
                                        <?php if (request()->is('/')):?><img src="{{asset('images/NIC-Logo.png')}}" class="logo padding-top-10"><?php else:?><a href="{{url('login')}}">Enter Now</a><?php endif;?>
                                    @else
                                        <?php if (request()->is('/')):?>
                                            <img src="{{asset('images/NIC-Logo.png')}}" class="logo padding-top-10">
                                            <?php else:?>
