            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="content-post">
                        ...
                        <p class="fontsize20">The participants are required to submit their entry online. The online portal allows you to register and upload your submission. If you don't have an account, it's easy to <a href="{{url('register')}}" style="color: #FEBD21;">create one</a>. If you do, <a href="{{url('login')}}" style="color: #FEBD21">sign in</a> and get started today. After creating and confirming your account, sign in and click on the Participate Now button. Here, you can create a new entry</p>
                    </div>
                    <div class="divider"></div>
                    <div class="content-post">
