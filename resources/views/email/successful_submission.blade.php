                        ...
                        <table style="{{ $style['email-body_inner'] }}" align="center" width="570" cellpadding="0" cellspacing="0">
                            <tr>
                                <td style="{{ $fontFamily }} {{ $style['email-body_cell'] }}">
                                    ...
                                    <p style="{{$style['paragraph']}}">
                                        Your submission for the NDA will be evaluated by a panel. The jury panel will go through all the entries submitted and shortlisting will take place. The shortlisted teams will be announced on the NDA website. These teams will be given the details of the final phase. The awards ceremony will be held on 22nd April at Lahore University of Management Sciences. Further details of the venue will be provided to the shortlisted teams.
                                    </p>
                                    <p style="{{$style['paragraph']}}">
                                        The NDA are held by the larger parent event, UXPakistan. It is a two-day conference being held on 21st and 22nd April 2018. This will be the 2nd edition of this highly anticipated user experience conference which include workshops, sessions by esteemed and competent speakers, start-up demos and more. The conference will focus on promoting the concept of “Design in all Fields”. If you haven’t already registered for the conference we urge you to do so as this conference is one of a kind in Pakistan. For more details visit our website and get yourself registered for the conference <a href="https://www.uxpakistan.com/tickets/" target="_blank">here</a>.
                                    </p>
                                    <p style="{{$style['paragraph']}}">
                                        The submission charges for your category is <?php if($submission->type === 'Professional'):?>2000<?php else:?>1000<?php endif?> PKR. You selected the payment method <strong>{{$submission->payment_method}}</strong> so kindly find the details of it as mentioned below and make sure you do the payment in the next two weeks from now or else your submission will not be considered.
                                    </p>
