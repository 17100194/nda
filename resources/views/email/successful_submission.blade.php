                        ...
                        <table style="{{ $style['email-body_inner'] }}" align="center" width="570" cellpadding="0" cellspacing="0">
                            <tr>
                                <td style="{{ $fontFamily }} {{ $style['email-body_cell'] }}">
                                    ...
                                    <p style="{{$style['paragraph']}}">
                                        The submission charges for your category is <?php if($submission->type === 'Professional'):?>3000<?php else:?>1500<?php endif?> PKR. You selected the payment method <strong>{{$submission->payment_method}}</strong> so kindly find the details of it as mentioned below and make sure you do the payment in the next two weeks from now or else your submission will not be considered.
                                    </p>
